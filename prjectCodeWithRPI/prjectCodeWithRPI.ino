...
void loop() {
    ...
    if (inputCommand.startsWith("forward")) {
    ...
    else if (inputCommand.startsWith("left")) {
        digitalWrite(motor1Pin1, HIGH); 
        digitalWrite(motor1Pin2, LOW); 
        digitalWrite(motor2Pin1, LOW);
    ...
    else if (inputCommand.startsWith("stop") || stateStop == 1) {
    ...
    else if (inputCommand.startsWith("right")) {
        digitalWrite(motor1Pin1, LOW); 
        digitalWrite(motor1Pin2, LOW); 
        digitalWrite(motor2Pin1, LOW);
        digitalWrite(motor2Pin2, HIGH);
    ...
    else if (inputCommand.startsWith("backward")) {
        digitalWrite(motor1Pin1, LOW); 
